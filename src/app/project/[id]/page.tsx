...
import { ArrowLeft, Github, ExternalLink, Code2, Server, Database, Zap } from "lucide-react";
...
const categoryIcons: Record<Project["category"], React.ComponentType<{ className?: string }>> = {
  web: Code2,
  mobile: Server,
  ai: Zap,
  fullstack: Database,
...
const projectLogs: Record<string, { date: string; logs: Array<{ title: string; content: Array<{ type: "text" | "image" | "list" | "tip"; value: string; title?: string; items?: string[] }> }> }> = {
  resolvex: {
    date: "March 2024",
    logs: [
      {
